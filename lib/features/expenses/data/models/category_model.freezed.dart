...
class _$CategoryModelImpl implements _CategoryModel {
  const _$CategoryModelImpl(
      ...
      @HiveField(4) this.isDefault = false,
      @HiveField(5) this.isIncome = false});
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, icon: $icon, color: $color, isDefault: $isDefault, isIncome: $isIncome)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, icon, color, isDefault, isIncome);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      @HiveField(4) final bool isDefault,
      @HiveField(5) final bool isIncome}) = _$CategoryModelImpl;
